...
/**
 * Client-safe field validators shared by buyer/seller forms (web + mobile).
 * They exist so users get immediate, specific feedback before a request is made;
 * server actions / RPCs keep their own authoritative validation.
 */
