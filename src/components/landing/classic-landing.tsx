...
/* ---------------------------------------------------------------------------
 * SnapDuka public landing page — the storefront-builder pitch, shown to every
 * market until the trust-led landing (trust-landing.tsx) is switched on for
 * it with the `new_homepage` flag. Kept accurate in the meantime: orders can
 * arrive unpaid (cash on delivery), so nothing here promises otherwise.
...
const STEPS = [
  ...
  },
  {
    ...
    body: "Every order arrives tracked — paid online, or marked for payment on delivery. Confirm it, arrange delivery or pickup, and mark it fulfilled.",
          ...
          <div role="img" aria-label="Preview of a SnapDuka storefront, checkout and paid-order notification" className="relative grid min-h-[480px] place-items-center py-3">
            ...
            <div className="absolute right-0 top-[5%] flex w-[min(240px,64vw)] items-start gap-2.5 rounded-[14px] border border-[#EAE2D6] bg-white px-3.5 py-3 shadow-[0_14px_30px_-12px_rgba(33,27,20,0.26)] motion-safe:animate-[sd-toast-in_0.7s_ease_0.9s_both] lg:right-5">
              ...
              <div className="min-w-0">
                ...
                <p className="text-[11.5px] leading-[1.45] text-[#57504A]">Order #1042 · GHS 450.00 paid online</p>
              </div>
            </div>
